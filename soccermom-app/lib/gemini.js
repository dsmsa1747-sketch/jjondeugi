...
2단계 — 축구 영상이 맞을 때만, 영상에서 관찰된 플레이를 근거로 코칭 분석을 작성하세요.
  - scores: 6개 능력치를 0~100 정수로 평가하세요. 영상에서 근거가 부족하면 50 기준으로 보수적으로.
  - 각 강점/개선점은 '영상에서 본 구체적 장면'을 언급하세요(막연한 일반론 금지).

다음 JSON으로만 응답하세요 (다른 텍스트 없이):
{
  "is_soccer": true 또는 false,
  "reason": "판별 근거 (영상에서 실제로 본 것, 1문장)",
  "scores": { "슈팅": 0~100, "패스": 0~100, "드리블": 0~100, "수비": 0~100, "체력": 0~100, "판단력": 0~100 },
  "overall": 0~100,
...
축구가 아니면 scores 는 모두 0, strengths/improvements/drills 는 빈 배열, highlights 는 빈 문자열로 두세요.`;
